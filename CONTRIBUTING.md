# Contributing to `healthcheck_endpoint`
...
3. `healthcheck_endpoint` [issue template](.github/ISSUE_TEMPLATE/issue_report.md)/[bug template](.github/ISSUE_TEMPLATE/bug_report.md)
...
1. `healthcheck_endpoint` [pull request template](.github/PULL_REQUEST_TEMPLATE.md)
